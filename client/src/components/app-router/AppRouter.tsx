...
import {getAccessToken, getAuthorizeLoading} from "../../store/selectors/token.selector";
...
const AppRouter: FC = () => {
    const authorizeLoading = useAppSelector(getAuthorizeLoading);
    const accessToken = useAppSelector(getAccessToken);

    return (
        <Router>
            {authorizeLoading ? null : accessToken ? AppRoutes : AuthorizeRoutes}
        </Router>
    );
}
